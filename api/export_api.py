...
def export_chats() -> tuple[Response, int] | Response:
    ...
    try:
        ...
        if not os.path.isfile(gdb):
            ...
            return api_error("Cursor global storage not found", "global_storage_not_found", 404)
        ...
        if count == 0:
            ...
            return api_error(
                ...
                (
                    "no_conversations_since_last_export"
                    if since == "last"
                    else "no_conversations_to_export"
                ),
                404,
            )
        ...
        return api_error("Export failed", "export_failed", 500)
